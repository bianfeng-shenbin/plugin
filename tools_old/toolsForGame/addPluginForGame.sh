...
if [ -d "${TARGET_ROOT}" ]; then
	...
	# Combin ForAssets directory to the assets dir of game project
    GAME_ASSETS_DIR="${GAME_PROJECT_DIR}"/assets
    ${SHELL_DIR}/modifyAssets.sh "${GAME_ASSETS_DIR}"
    GAME_RES_DIR="${GAME_PROJECT_DIR}"/../Resources
    ${SHELL_DIR}/modifyAssets.sh "${GAME_RES_DIR}"

	# Combin ForLibs directory to the libs dir of game project
