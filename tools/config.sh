...
export ALL_PLUGINS=("baidupush" "weibo" "iapppay" \
"Cmgame" "Cmpay" "Ctcpay" "Unipay" "360" \
"sysfunc_old" "sysfunc_old_no_sensitive" "talkingdata" "sysfunc_plus" "BaiduPX" "BaiduAppX")
